...
@section('content')
        ...
        <div class="breadgram-image">
            ...
            <div class="breadgram-hero-area">
                ...
                <h6 class="text-center mt-3"><span
                        class="text-dark">{{ $chairman_message->{app()->getLocale() . '_breadcrumb_1'} }}</span> / <span
                        class="text-success fw-bold">{{ $chairman_message->{app()->getLocale() . '_breadcrumb_2'} }}</span>
                </h6>
    ...
    <div class="container cus_mt_20">
        <div class="row profile_area cus_mb_20">
            ...
            <div class="col-lg-8 col-md-7 col-sm-12 col-12 cus_mt_20 profile_info_area cha_description">
