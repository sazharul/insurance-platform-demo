...
@section('title', 'Business Committee')
        ...
        <div class="breadgram-image">
            ...
            <div class="breadgram-hero-area">
                ...
                <h6 class="text-center mt-3"><span class="text-dark"> {{__('Who we are')}} </span> / <span
                        class="text-success fw-bold"> {{__('Business Committee')}} </span></h6>
    ...
    <div class="container">
        ...
        <div class="row board_commitee">
            <div class="col-lg-12 text-center">
                <h2>{{ $commiittee_name[2]->{app()->getLocale() . '_name'} }}</h2>
            </div>
        </div>
        <div class="row board_commitee cus_mb_20 justify-content-center">
            @foreach ($commiittee_member_name as $member)
                <div class="col-lg-3 col-md-3 col-sm-6 col-12 cus_mt_10 text-center">
