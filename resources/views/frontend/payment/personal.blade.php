...
<body>
    ...
    <div class="invoice_area" id="invoice_area" style="width: 100%;">
        <div class="invioce_header" style="padding-left: 10%; padding-right: 10%; text-align:center;">
            ...
            <h2 style="margin: 0px;">PREMIUM BILL Personal Accident Insurance
            </h2>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p style="display: inline-block; margin: 0px; margin-bottom: 10px; font-size: 20px;">
                            Class of Occupation: {{ $data['occupation']->en_name }}
                        </p> <br>
                        <p style="display: inline-block; margin: 0px; margin-bottom: 10px; font-size: 20px;">
                            Risk Coverage: {{ $data['risk']->en_name }}</p> <br>
                        <p style="display: inline-block; margin: 0px; margin-bottom: 10px; font-size: 20px;">
                            Medicle Benifits: {{ $order_details->personal_medical_benifit == 0 ? 'No' : 'Yes' }}</p> <br>

                        <div class="inside_info_box" style=" padding-left: 100px; display: flow-root;">
                            <div class="inside_left_info" style="float: left; margin-top: 10px; font-size: 18px;">Toal
                                Sum Insured: </div>
                        ...
                        <div class="inside_info_box" style=" padding-left: 100px; display: flow-root;">
                            <div class="inside_left_info" style="float: left; margin-top: 10px; font-size: 18px;">Stamp Charge</div>
                            <div class="inside_right_info" style="float: right; margin-top: 10px; font-size: 18px;">Tk.
                                {{ $order_details->stamp_charge }}</div>
                        </div>
