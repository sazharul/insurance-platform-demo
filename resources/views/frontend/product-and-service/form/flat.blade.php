                            ...
                            <div class="col-lg-12">
                                <form action="{{ route('calculation.invoice') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="total_amount"
                                        value="{{ $request_all['total_amount'] }}">
                                    <input type="hidden" name="teriff_code"
                                        value="{{ $request_all['teriff_code'] ?? $criteria->teriff_code }}">
                                    <input type="hidden" name="flat_district_id"
                                        value="{{ $request_all['flat_district_id'] ?? $criteria->district_id }}">
                                    <input type="hidden" name="flat_location_id"
                                        value="{{ $request_all['flat_location_id'] ?? $criteria->location_id }}">
                                    <input type="hidden" name="flat_risk_coverage"
                                        value="{{ $request_all['flat_risk_coverage'] ?? $criteria->risk_coverage_id }}">
                                    ...
                                    <input type="hidden" name="insured_amount"
                                        value="{{ $request_all['insured_amount'] ?? $total_premium }}">
