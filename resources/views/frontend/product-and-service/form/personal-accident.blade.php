                                ...
                                <form action="{{ route('calculation.invoice') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="contact_area calculator_submit">
                                        <div class="row">
                                            ...
                                            @php
                                                $min = date('Y-m-d', strtotime(date('Y-m-d') . ' - ' . $pv->age . ' years'));
                                            @endphp
                                            <div class="col-lg-7 col-md-7">
                                                <div class="input_field">
                                                    <label for="">{{ __('Date of Birth') }}*</label>
                                                    <input type="text" class="form-control pp_date" name="dob"
                                                           value="" placeholder="dd/mm/yy" aria-label="Username"
                                                           required max="{{ date('Y-m-d') }}" min="{{ $min }}">
                                    ...
                                    <input type="hidden" name="vat" value="{{ $request_all['vat'] ?? $vat }}">

                                    <input type="hidden" name="total_amount"
                                           value="{{ $request_all['total_amount'] ?? $total_premium }}">
                                    <input type="hidden" name="teriff_code"
                                           value="{{ $request_all['teriff_code'] ?? $teriff->teriff_code }}">
                                    <input type="hidden" name="personal_medical_benifit"
                                           value="{{ $request_all['personal_medical_benifit'] ?? $medical_amount }}">
                                    <input type="hidden" name="occupation_id"
                                           value="{{ $request_all['occupation_id'] ?? $occupation->id }}">
                                    <input type="hidden" name="risk_coverage_id"
                                           value="{{ $request_all['risk_coverage_id'] ?? $risk->id }}">
                                    <input type="hidden" name="stamp_charge"
                                           value="{{ $request_all['stamp_charge'] ?? $stamp_charge }}">
                                    <input type="hidden" name="insured_amount"
                                           value="{{ $request_all['insured_amount'] ?? $request_all['total_amount'] }}">
