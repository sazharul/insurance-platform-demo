                            ...
                            <div class="col-lg-12">
                                <form action="{{ route('calculation.invoice') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5">
                                                <div class="input_field">
                                                    ...
                                                    <input type="text" class="form-control" name="insured_email_address"
                                                           value="" placeholder="{{ __('Insured E-mail Address') }}*"
                                                           aria-label="Username" required>
                                            ...
                                            <div class="col-lg-7 col-md-7">
                                                <div class="input_field">
                                                    ...
                                                    <input type="text" class="form-control" name="insured_occupation"
                                                           value="" placeholder="{{ __('Insured\'s Occupation') }}*"
                                                           aria-label="Username" required>
                                            ...
                                            <div class="col-lg-5 col-md-5">
                                                <div class="input_field">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           name="insured_passport_number" value=""
                                    ...
                                    <input type="hidden" name="teriff_code"
                                           value="{{ $request_all['teriff_code'] ?? $country->teriff_code }}">
                                    ...
                                    <input type="hidden" name="stamp_charge"
                                           value="{{ $request_all['stamp_charge'] ?? $stamp_amount }}">

                                    <input type="hidden" name="insurance_sub_type_id"
                                           value="{{ $request_all['insurance_sub_type_id'] ?? $insurance_subtype->id }}">
                                    ...
                                    <input type="hidden" name="user_date_of_departure"
                                           value="{{ $request_all['user_date_of_departure'] }}">
                                    <input type="hidden" name="user_return_date"
                                           value="{{ $request_all['user_return_date'] }}">
                                    <div class="contact_area calculator_submit">
                                        <div class="row">
                                            <div class="text-center">
                                    ...
                                    <div class="contact_area calculator_submit">
                                        <div class="col-lg-12">
                                            <div class="terms_section">
                                                ...
                                                <button class="payment_proceed_btn">{{ __('Submit') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
