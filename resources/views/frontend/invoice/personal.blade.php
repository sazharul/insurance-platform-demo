                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered east_invoice_table">
                                        <tbody>
                                            <tr>
                                                <td class="header_title" colspan="100">Insurance Information</td>
                                            </tr>
                                            <tr>
                                                <td>{{ __('Class of Occupation') }}</td>
                                                <td>{{ $teriff->occupation->{app()->getLocale() . '_name'} }}</td>
                                            </tr>

                                            <tr>
                                                <td>{{ __('Scope of Cover') }}</td>
                                                <td>{{ $teriff->risk_coverage->{app()->getLocale() . '_name'} }}</td>
                                            </tr>

                                            <tr>
                                                <td>{{ __('Medical Benefit') }}</td>
                                                <td>{{ $request_all->medical_benifit == true ? 'Yes' : 'No' }}</td>
                                            </tr>

                                            <tr>
                                                <td>{{ __('Sum Insured') }}</td>
                                                <td>{{ app()->getLocale() == 'en' ? number_format($request_all->total_amount, 2) : $numto->bnCommaLakh($request_all->total_amount) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-bordered east_invoice_table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ app()->getLocale() == 'en' ? number_format($allData->pa, 2) : $numto->bnCommaLakh($allData->pa) }}
                                            ...
                                            @if ($request_all->medical_benifit == true)
                                                <tr>
                                                    ...
                                                    <td> {{ app()->getLocale() == 'en' ? number_format($allData->medical_amount, 2) : $numto->bnCommaLakh($allData->medical_amount) }}
                                            ...
                                            <tr>
                                                <td>{{ __('Stamp Duty') }}</td>
                                                <td> {{ app()->getLocale() == 'en' ? number_format($allData->stamp_charge, 2) : $numto->bnCommaLakh($allData->stamp_charge) }}
