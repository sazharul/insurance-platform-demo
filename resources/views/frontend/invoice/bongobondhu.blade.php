                                    ...
                                    <table class="table table-bordered east_invoice_table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Bangobandhu Suroksha Bima</td>
                                            </tr>
                                    ...
                                    <table class="table table-bordered east_invoice_table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $calculation->capital_sum_insured }}</td>
                                            </tr>

                                            <tr>
                                                <td>Net Premium</td>
                                                <td>{{ $calculation->net_premium }}</td>
                                            </tr>

                                            <tr>
                                                <td>VAT@ 15%</td>
                                                <td>{{ $calculation->net_premium * ($calculation->vat/100) }}</td>
                                            </tr>

                                            <tr style="color: red;">
                                                <td>Total</td>
                                                <td>{{ $calculation->net_premium+$calculation->net_premium * ($calculation->vat/100) }}</td>
                                            </tr>
                            ...
                            @if($invoice_info->status != 'Paid')
                                <div class="col-lg-12" style="text-align: center;">
                                    <form action="{{ url('/pay') }}" method="POST">
                                        ...
                                        <a href="{{ route('ps.bangabandhu_surokkha_bima') }}" class="danger_payment_btn">Close</a>
