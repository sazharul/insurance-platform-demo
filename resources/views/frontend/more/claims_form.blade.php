    ...
    <div class="breadgram-image">
        ...
        <div class="breadgram-hero-area">
            ...
            <h6 class="text-center mt-3"><span
                    class="text-dark">{{ $claims_form->{app()->getLocale() . '_breadcrumb_1'} }}</span> / <span
...
<div class="container-fluid">
    <div class="container">
        <div class="row justify-content-center">
            @foreach ($claims_form_list as $item)
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="animation_btn_view">
                                <a href="{{ route('more.claims_form_details', $item->id)}}" class="">
                                    <img class="left_icon" src="{{ asset('images/website/view_report.png') }}" alt="">  {{ $claims_form->{app()->getLocale() . '_btn_text'} }}
