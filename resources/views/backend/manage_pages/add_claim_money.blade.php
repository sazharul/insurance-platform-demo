...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Add Claim Money</div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form method="POST" action="{{ route('save_claim_money') }}" class="form-horizontal" enctype="multipart/form-data"">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mt-4">
                                        ...
                                        <input type="text" name="en_claim_year" class="form-control" id="basiInput"
                                ...
                                <div class="col-md-12">
                                    <div class="mt-4">
                                        <label for="basiInput" class="form-label">Claim Year (Bangla)<span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="bn_claim_year" class="form-control" id="basiInput"
                                            required placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mt-4">
                                        <label for="basiInput" class="form-label">Claim Money (English) <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="en_claim_money" class="form-control" id="basiInput"
                                            required placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mt-4">
                                        <label for="basiInput" class="form-label">Claim Money (Bangla)<span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="bn_claim_money" class="form-control" id="basiInput"
                                            required placeholder="">
                                    </div>
                                </div>
