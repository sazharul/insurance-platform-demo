...
@section('title', 'Additional Coverage Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Additional Coverage</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.additional-coverage.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
