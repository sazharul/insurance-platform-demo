...
@section('title', 'Strike Riot Civil Commotion (SRCC) Type Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Strike Riot Civil Commotion (SRCC) Type</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.strike-riot-civil-commotions.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
