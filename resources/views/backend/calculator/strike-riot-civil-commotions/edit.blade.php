...
@section('title', 'Strike Riot Civil Commotion (SRCC) Type Edit Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Edit Strike Riot Civil Commotion (SRCC) Type</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.strike-riot-civil-commotions.update', $institution->id) }}" method="post"
                                        ...
                                        <select name="calculator_id" id="" class="form-control" required>
                                            ...
                                            @foreach ($calculators as $calculator)
                                                <option value="{{ $calculator->id }}"
                                                    {{ $calculator->id == $institution->calculator_id ? 'selected' : '' }}>
