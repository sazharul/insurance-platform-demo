...
@section('title', 'Insurance District Edit Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Edit Insurance District</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.insurance-districts.update', $institution->id) }}" method="post"
