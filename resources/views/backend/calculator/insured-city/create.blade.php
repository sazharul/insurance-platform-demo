...
@section('title', 'Insured City Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Insured City</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.insured-city.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
