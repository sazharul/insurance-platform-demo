...
@section('title', 'Cargo Products Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Cargo Products</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.cargo-products.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for=""><input type="radio" name="member" value="1" checked>Yes</label>
                                        <label for=""><input type="radio" name="member" value="0">No</label>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
