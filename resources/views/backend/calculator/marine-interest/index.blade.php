...
@section('title', 'Marine Interest Type Manage Page')
                        ...
                        <div class="white_box_tittle list_header">
                            ...
                            <div class="box_right d-flex lms_block">
                                ...
                                <div class="add_button ms-2">
                                    <a href="{{ route('admin.calculator.createMarineInterest.create') }}"
                                ...
                                <tbody>
                                    @foreach ($teriffs as $teriff)
                                        <tr>
                                            ...
                                            <td>{!! $teriff->en_name !!}</td>
                                            <td>{!! $teriff->bn_name !!}</td>
                                             <td>{!! $teriff->value !!}%</td>
                                            <td><a href="{{ route('admin.calculator.statusMarineInterest.status', $teriff->id) }}"
                                                    class="fw-bolder status_btn {{ $teriff->status == 1 ? '' : 'danger_btn' }}">{!! $teriff->status == 1 ? 'Active' : 'Inactive' !!}</a>
                                            </td>
                                            <td><a href="{{ route('admin.calculator.editMarineInterest.edit', $teriff->id) }}"
