...
@section('title', 'Motor Insurance Edit Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Edit Motor Insurance</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.motor-insurance.update', $ins->id) }}" method="post"
                                        ...
                                        <select name="calculator_id" id="" class="form-control" required>
                                            ...
                                            @foreach ($calculators as $calculator)
                                                <option value="{{ $calculator->id }}"
                                                    {{ $calculator->id == $ins->calculator_id ? 'selected' : '' }}>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        @if (isset($ins->color_image))
                                            <img src="{{ asset($ins->color_image) }}" alt="" style="max-height: 100px; max-width: 100px;">
                                        @endif
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        @if (isset($ins->white_image))
                                            <img class="bg-dark" src="{{ asset($ins->white_image) }}" alt="" style="max-height: 100px; max-width: 100px;">
                                        @endif
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <label for=""><input type="radio" name="status" value="1"
                                                {{ $ins->status == 1 ? 'checked' : '' }} required>Active</label>
                                        <label for=""><input type="radio" name="status" value="0"
                                                {{ $ins->status == 0 ? 'checked' : '' }} required>Inactive</label>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
