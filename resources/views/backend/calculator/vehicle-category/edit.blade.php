...
@section('title', 'Vehicle Category Edit Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Edit Vehicle Category</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.vehicle-category.update', $cate->id) }}" method="post"
                                        ...
                                        <select name="calculator_id" id="" class="form-control" required>
                                            ...
                                            @foreach ($calculators as $calculator)
                                                <option value="{{ $calculator->id }}"
                                                    {{ $calculator->id == $cate->calculator_id ? 'selected' : '' }}>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        @if (isset($cate->color_image))
                                            <img src="{{ asset($cate->color_image) }}" alt="" style="max-height: 100px; max-width: 100px;">
                                        @endif
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        @if (isset($cate->white_image))
                                            <img class="bg-dark" src="{{ asset($cate->white_image) }}" alt="" style="max-height: 100px; max-width: 100px;">
                                        @endif
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <label for=""><input type="radio" name="status" value="1"
                                                {{ $cate->status == 1 ? 'checked' : '' }} required>Active</label>
                                        <label for=""><input type="radio" name="status" value="0"
                                                {{ $cate->status == 0 ? 'checked' : '' }} required>Inactive</label>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
