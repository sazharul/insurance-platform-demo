...
@section('title', 'Cash in counter and in-transit Tariff Type Manage Page')
                ...
                <div class="white_card_body">
                    <div class="QA_section">
                        <div class="white_box_tittle list_header">
                            <h4>Cash in Counter Tariff Type</h4>
                            <div class="box_right d-flex lms_block">
                                ...
                                <div class="add_button ms-2">
                                    <a href="{{ route('admin.calculator.createCashInCounterTeriff.create') }}"
                                ...
                                <tbody>
                                    @foreach ($teriffs as $teriff)
                                        <tr>
                                            ...
                                            <td>{!! $teriff->buildingConstruction->en_class_title ?? '-' !!}</td>
                                            <td>{!! $teriff->value !!}%</td>
                                            <td><a href="{{ route('admin.calculator.statusCashInCounterTeriff.status', $teriff->id) }}"
                                                    class="fw-bolder status_btn {{ $teriff->status == 1 ? '' : 'danger_btn' }}">{!! $teriff->status == 1 ? 'Active' : 'Inactive' !!}</a>
                                            </td>
                                            <td><a href="{{ route('admin.calculator.editCashInCounterTeriff.edit', $teriff->id) }}"
