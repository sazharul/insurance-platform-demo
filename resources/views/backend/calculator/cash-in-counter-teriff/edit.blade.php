...
@section('title', 'Cash In Counter Tariff Type Edit Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Edit Cash in Counter Tariff Type</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.updateCashInCounterTeriff.update', $teriff->id) }}"
