...
@section('title', 'Fire Interest Tariff Type Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Fire Interest Tariff Type</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.StoreFireInterestTeriff.store') }}" method="post"
                                ...
                                <div class="row mt-3" id="occupation_type">
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="occupation_id" id="occupation_id" class="form-control" required onchange="getPropertyTypeItem(this)">
                                            <option value="" selected>select a option</option>
                                ...
                                <div class="row mt-3" id="property1">
                                    <label for="" class="col-md-12 "
                                        style="font-weight: bold; font-size: 20px;">Member of association (if "<i>Interest Type</i>" keep it empty )</label>
                                    <div class="col-md-12 ">
                                ...
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 "
                                        style="font-weight: bold; font-size: 20px;">Interest Type (if <i>Member of association</i> keep it empty )</label>
                                    <div class="col-md-12 ">
...
@section('js')
    ...
    <script type="text/javascript">
        function getPropertyTypeItem(e) {
            var occupation_id = $(e).val();


            $.ajax({
                type: "get",
                url: "{{ url('admin/calculator/fire-interest-type/') }}/" + occupation_id,
                dataType:'html',
                success: function(response) {
                    // console.log(response);
                    $('#interest_id').html(response);
                }
            });
        }
    </script>
