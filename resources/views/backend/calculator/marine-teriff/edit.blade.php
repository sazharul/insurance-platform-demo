                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.calculator.updateMarineTeriff.update', $teriff->id) }}"
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="cargo_product_id" id="" class="form-control">
                                            ...
                                            @foreach ($cargo_product as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($teriff->cargo_product_id == $item->id) {{ 'selected' }} @endif>
                                                    {{ $item->en_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="member_id" id="" class="form-control">
                                            ...
                                            @foreach ($member_association as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($teriff->member_id == $item->id) {{ 'selected' }} @endif>
                                                    {{ $item->en_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="teriff_id" id="" class="form-control">
                                            ...
                                            @foreach ($teriff_type as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($teriff->teriff_id == $item->id) {{ 'selected' }} @endif>
                                                    {{ $item->en_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="carried_by_id" id="" class="form-control">
                                            ...
                                            @foreach ($carried_by as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($teriff->carried_by_id == $item->id) {{ 'selected' }} @endif>
                                                    {{ $item->en_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="risk_cover_id" id="" class="form-control">
                                            @foreach ($teriff->carriedBy->calculatorRiskCoverage as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($teriff->risk_cover_id == $item->id) {{ 'selected' }} @endif>
                                                    {{ $item->en_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <select name="interest_type_id" id="" class="form-control">
                                            @foreach ($interest_type as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($teriff->interest_type_id == $item->id) {{ 'selected' }} @endif>
                                                    {{ $item->en_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
