...
@section('title', 'Member of Association Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Member of Association</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.associations.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
