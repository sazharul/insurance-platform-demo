...
@section('title', 'Select Property Location Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Select Property Location</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.property.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
