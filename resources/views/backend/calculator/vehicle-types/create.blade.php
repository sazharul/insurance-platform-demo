...
@section('title', 'Vehicle Type Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Vehicle Type</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.vehicle-types.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12">
                                        <select name="calculator_vehicle_category_id" id="" class="form-control" required>
                                            <option value="" selected disabled>select a option</option>
                                ...
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Fiv value</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="value" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Weight</label>
                                    <div class="col-md-12 ">
                                        <label for=""><input type="radio" name="weight" value="1" checked required>Yes</label>
                                        <label for=""><input type="radio" name="weight" value="0" required>No</label>
                                    </div>
                                </div>
                                <div class="row mt-3">
