...
@section('title', 'Building Construction Roofs Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Building Construction Roofs</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.construction-roofs.store') }}" method="post"
