...
@section('title', 'Type of Property Or Occupation Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Type of Property Or Occupation</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('admin.calculator.occupation.store') }}" method="post"
