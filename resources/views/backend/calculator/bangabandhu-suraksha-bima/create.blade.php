...
@section('title', 'Bangabandhu Suraksha Bima Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Bangabandhu Suraksha Bima</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.bangabandhu-suraksha-bima.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="white_box mb_30">
                                            <label for="basiInput" class="form-label">Title English<span
                                                class="text-danger">*</span></label>
                                            <textarea class="summernote" name="en_title" id="" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <div class="white_box mb_30">
                                            <label for="basiInput" class="form-label">Title Bangla <span
                                                class="text-danger">*</span></label>
                                            <textarea class="summernote" name="bn_title" id="" cols="30" rows="10" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_subtitle" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">SubTitle Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_subtitle" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_title1" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero Title1 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_title1" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_subtitle1" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero SubTitle1 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_subtitle1" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_title2" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero Title2 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_title2" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_subtitle2" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero SubTitle2 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_subtitle2" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_title3" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero Title3 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_title3" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_subtitle3" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero SubTitle3 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_subtitle3" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_title4" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero Title4 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_title4" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="text" name="en_hero_subtitle4" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <label for="" class="col-md-12 " style="font-weight: bold; font-size: 20px;">Hero SubTitle4 Bangla</label>
                                    <div class="col-md-12 ">
                                        <input type="text" name="bn_hero_subtitle4" class="form-control" required>
                                    </div>
                                </div>
