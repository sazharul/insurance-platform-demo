...
@section('title', 'Insurance Sub Type Create Page')
                ...
                <div class="col-md-11 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-capitalize">Add Insurance Sub Type</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{route('admin.calculator.insurance-sub-type.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mt-3">
