    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/admin/department/create') }}" class="btn btn-success btn-sm" title="Add New">
                        <i class="fa fa-plus" aria-hidden="true"></i> Add New
                    </a>
                    <form method="GET" action="{{ url('/admin/department') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0" role="search" style="width: 25%;float: right;">
                        ...
                        <table class="table">
                            ...
                            @foreach($department as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/department/' . $item->id) }}" title="View Department"> </a>
