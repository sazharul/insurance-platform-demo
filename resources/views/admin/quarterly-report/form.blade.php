<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($quarterlyreport->en_title) ? $quarterlyreport->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($quarterlyreport->bn_title) ? $quarterlyreport->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($quarterlyreport->en_breadcrumb_1) ? $quarterlyreport->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($quarterlyreport->bn_breadcrumb_1) ? $quarterlyreport->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($quarterlyreport->en_breadcrumb_2) ? $quarterlyreport->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($quarterlyreport->bn_breadcrumb_2) ? $quarterlyreport->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_btn_text" type="text" id="en_btn_text" value="{{ isset($quarterlyreport->en_btn_text) ? $quarterlyreport->en_btn_text : ''}}" >
...
<div class="form-group {{ $errors->has('bn_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_btn_text" type="text" id="bn_btn_text" value="{{ isset($quarterlyreport->bn_btn_text) ? $quarterlyreport->bn_btn_text : ''}}" >
