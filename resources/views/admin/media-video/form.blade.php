<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($mediavideo->en_title) ? $mediavideo->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($mediavideo->bn_title) ? $mediavideo->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($mediavideo->en_breadcrumb_1) ? $mediavideo->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($mediavideo->bn_breadcrumb_1) ? $mediavideo->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($mediavideo->en_breadcrumb_2) ? $mediavideo->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($mediavideo->bn_breadcrumb_2) ? $mediavideo->bn_breadcrumb_2 : ''}}" >
