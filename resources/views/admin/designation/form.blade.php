<div class="form-group {{ $errors->has('en_name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_name" type="text" id="en_name" value="{{ isset($designation->en_name) ? $designation->en_name : ''}}" >
...
<div class="form-group {{ $errors->has('bn_name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_name" type="text" id="bn_name" value="{{ isset($designation->bn_name) ? $designation->bn_name : ''}}" >
