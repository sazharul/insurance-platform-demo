<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($distributionpolicy->en_title) ? $distributionpolicy->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($distributionpolicy->bn_title) ? $distributionpolicy->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($distributionpolicy->en_breadcrumb_1) ? $distributionpolicy->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($distributionpolicy->bn_breadcrumb_1) ? $distributionpolicy->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($distributionpolicy->en_breadcrumb_2) ? $distributionpolicy->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($distributionpolicy->bn_breadcrumb_2) ? $distributionpolicy->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_heading') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_heading" type="text" id="en_heading" value="{{ isset($distributionpolicy->en_heading) ? $distributionpolicy->en_heading : ''}}" >
...
<div class="form-group {{ $errors->has('bn_heading') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_heading" type="text" id="bn_heading" value="{{ isset($distributionpolicy->bn_heading) ? $distributionpolicy->bn_heading : ''}}" >
...
<div class="form-group {{ $errors->has('pdf_file') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pdf_file" type="file" id="pdf_file" value="{{ isset($distributionpolicy->pdf_file) ? $distributionpolicy->pdf_file : ''}}" >
...
<div class="form-group {{ $errors->has('en_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_btn_text" type="text" id="en_btn_text" value="{{ isset($distributionpolicy->en_btn_text) ? $distributionpolicy->en_btn_text : ''}}" >
...
<div class="form-group {{ $errors->has('bn_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_btn_text" type="text" id="bn_btn_text" value="{{ isset($distributionpolicy->bn_btn_text) ? $distributionpolicy->bn_btn_text : ''}}" >
