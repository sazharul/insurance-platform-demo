<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($directorreport->en_title) ? $directorreport->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($directorreport->bn_title) ? $directorreport->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($directorreport->en_breadcrumb_1) ? $directorreport->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($directorreport->bn_breadcrumb_1) ? $directorreport->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($directorreport->en_breadcrumb_2) ? $directorreport->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($directorreport->bn_breadcrumb_2) ? $directorreport->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_btn_text" type="text" id="en_btn_text" value="{{ isset($directorreport->en_btn_text) ? $directorreport->en_btn_text : ''}}" >
...
<div class="form-group {{ $errors->has('bn_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_btn_text" type="text" id="bn_btn_text" value="{{ isset($directorreport->bn_btn_text) ? $directorreport->bn_btn_text : ''}}" >
