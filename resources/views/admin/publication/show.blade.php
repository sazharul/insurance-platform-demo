                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr><th> En Title </th><td> {{ $publication->en_title }} </td></tr><tr><th> Bn Title </th><td> {{ $publication->bn_title }} </td></tr><tr><th> En Breadcrumb 1 </th><td> {{ $publication->en_breadcrumb_1 }} </td></tr>
                            </tbody>
                        </table>
                    </div>
