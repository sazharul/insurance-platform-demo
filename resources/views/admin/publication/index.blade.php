        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="{{ url('/admin/publication') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0" role="search" style="width: 25%;float: right;">
                        ...
                        <table class="table">
                            ...
                            @foreach($publication as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/publication/' . $item->id) }}" title="View Publication"> </a>
