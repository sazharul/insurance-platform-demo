<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($corporategovernance->en_title) ? $corporategovernance->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($corporategovernance->bn_title) ? $corporategovernance->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($corporategovernance->en_breadcrumb_1) ? $corporategovernance->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($corporategovernance->bn_breadcrumb_1) ? $corporategovernance->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($corporategovernance->en_breadcrumb_2) ? $corporategovernance->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($corporategovernance->bn_breadcrumb_2) ? $corporategovernance->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_subject') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_subject" type="text" id="en_subject" value="{{ isset($corporategovernance->en_subject) ? $corporategovernance->en_subject : ''}}" >
...
<div class="form-group {{ $errors->has('bn_subject') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_subject" type="text" id="bn_subject" value="{{ isset($corporategovernance->bn_subject) ? $corporategovernance->bn_subject : ''}}" >
...
<div class="form-group {{ $errors->has('pdf_file') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pdf_file" type="file" id="pdf_file" value="{{ isset($corporategovernance->pdf_file) ? $corporategovernance->pdf_file : ''}}" >
