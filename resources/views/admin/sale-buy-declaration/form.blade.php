<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($salebuydeclaration->en_title) ? $salebuydeclaration->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($salebuydeclaration->bn_title) ? $salebuydeclaration->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($salebuydeclaration->en_breadcrumb_1) ? $salebuydeclaration->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($salebuydeclaration->bn_breadcrumb_1) ? $salebuydeclaration->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($salebuydeclaration->en_breadcrumb_2) ? $salebuydeclaration->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($salebuydeclaration->bn_breadcrumb_2) ? $salebuydeclaration->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_heading') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_heading" type="text" id="en_heading" value="{{ isset($salebuydeclaration->en_heading) ? $salebuydeclaration->en_heading : ''}}" >
...
<div class="form-group {{ $errors->has('bn_heading') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_heading" type="text" id="bn_heading" value="{{ isset($salebuydeclaration->bn_heading) ? $salebuydeclaration->bn_heading : ''}}" >
