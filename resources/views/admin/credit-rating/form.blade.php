<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($creditrating->en_title) ? $creditrating->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($creditrating->bn_title) ? $creditrating->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($creditrating->en_breadcrumb_1) ? $creditrating->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($creditrating->bn_breadcrumb_1) ? $creditrating->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($creditrating->en_breadcrumb_2) ? $creditrating->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($creditrating->bn_breadcrumb_2) ? $creditrating->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_subject') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_subject" type="text" id="en_subject" value="{{ isset($creditrating->en_subject) ? $creditrating->en_subject : ''}}" >
...
<div class="form-group {{ $errors->has('bn_subject') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_subject" type="text" id="bn_subject" value="{{ isset($creditrating->bn_subject) ? $creditrating->bn_subject : ''}}" >
...
<div class="form-group {{ $errors->has('pdf_file') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pdf_file" type="file" id="pdf_file" value="{{ isset($creditrating->pdf_file) ? $creditrating->pdf_file : ''}}" >
