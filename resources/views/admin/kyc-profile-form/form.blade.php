<div class="form-group {{ $errors->has('en_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_title" type="text" id="en_title" value="{{ isset($kycprofileform->en_title) ? $kycprofileform->en_title : ''}}" >
...
<div class="form-group {{ $errors->has('bn_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_title" type="text" id="bn_title" value="{{ isset($kycprofileform->bn_title) ? $kycprofileform->bn_title : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_1" type="text" id="en_breadcrumb_1" value="{{ isset($kycprofileform->en_breadcrumb_1) ? $kycprofileform->en_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_1" type="text" id="bn_breadcrumb_1" value="{{ isset($kycprofileform->bn_breadcrumb_1) ? $kycprofileform->bn_breadcrumb_1 : ''}}" >
...
<div class="form-group {{ $errors->has('en_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_breadcrumb_2" type="text" id="en_breadcrumb_2" value="{{ isset($kycprofileform->en_breadcrumb_2) ? $kycprofileform->en_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('bn_breadcrumb_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_breadcrumb_2" type="text" id="bn_breadcrumb_2" value="{{ isset($kycprofileform->bn_breadcrumb_2) ? $kycprofileform->bn_breadcrumb_2 : ''}}" >
...
<div class="form-group {{ $errors->has('en_heading') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_heading" type="text" id="en_heading" value="{{ isset($kycprofileform->en_heading) ? $kycprofileform->en_heading : ''}}" >
...
<div class="form-group {{ $errors->has('bn_heading') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_heading" type="text" id="bn_heading" value="{{ isset($kycprofileform->bn_heading) ? $kycprofileform->bn_heading : ''}}" >
...
<div class="form-group {{ $errors->has('pdf_file') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="pdf_file" type="file" id="pdf_file" value="{{ isset($kycprofileform->pdf_file) ? $kycprofileform->pdf_file : ''}}" >
...
<div class="form-group {{ $errors->has('en_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="en_btn_text" type="text" id="en_btn_text" value="{{ isset($kycprofileform->en_btn_text) ? $kycprofileform->en_btn_text : ''}}" >
...
<div class="form-group {{ $errors->has('bn_btn_text') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bn_btn_text" type="text" id="bn_btn_text" value="{{ isset($kycprofileform->bn_btn_text) ? $kycprofileform->bn_btn_text : ''}}" >
