...
// Here we will define the response pattern
    ...
    public function setRequiredInfo(array $info) {
        // dd($info);
        $this->data['calculator_id'] = $info['calculator_id'];
...
// string (255)    Mandatory - It is the callback URL of your website where user will redirect if user canceled the transaction (Length: 255)
    ...
    public function setCustomerInfo(array $info) {
        ####################################################################################
        $this->data['insured_full_name']                = $info['insured_full_name'];
        $this->data['insured_nid']                      = $info['insured_nid'];
        $this->data['insured_permanent_address']        = $info['insured_permanent_address'];
        $this->data['insured_permanent_city']           = $info['insured_permanent_city'];
        $this->data['insured_mailing_address']          = $info['insured_mailing_address'];
        $this->data['insured_present_address']          = $info['insured_present_address'];
        $this->data['insured_mailing_city']             = $info['insured_mailing_city'];
        $this->data['insured_mailing_city']             = $info['insured_mailing_city'];
        $this->data['insured_email_address']            = $info['insured_email_address'];
        $this->data['insured_father_name']              = $info['insured_father_name'];
        $this->data['insured_mother_name']              = $info['insured_mother_name'];
        $this->data['insured_occupation']               = $info['insured_occupation'];
        $this->data['insured_passport_number']          = $info['insured_passport_number'];
        $this->data['nominee_full_name']                = $info['nominee_full_name'];
        $this->data['nominee_relationship']             = $info['nominee_relationship'];
        $this->data['nominee_address']                  = $info['nominee_address'];
        $this->data['nominee_mobile_number']            = $info['nominee_mobile_number'];
        $this->data['nominee_nid_or_birth_certificate'] = $info['nominee_nid_or_birth_certificate'];
        $this->data['policy_start_date']                = $info['policy_start_date'];
        $this->data['policy_end_date']                  = $info['policy_end_date'];
        $this->data['nominee_nid']                      = $info['nominee_nid'];
        $this->data['insured_nid_file']                 = $info['insured_nid_file'];
        $this->data['insured_amount']                   = $info['insured_amount'];
        $this->data['net_premium']                      = $info['net_premium'];
        $this->data['vat']                              = $info['vat'];
        $this->data['dob']                              = $info['dob'];
        $this->data['people_personal_id']               = $info['people_personal_id'];
        $this->data['people_number_of_people']          = $info['people_number_of_people'];
        $this->data['personal_medical_benifit']         = $info['personal_medical_benifit'];
        $this->data['occupation_id']                    = $info['occupation_id'];
        $this->data['risk_coverage_id']                 = $info['risk_coverage_id'];
        $this->data['stamp_charge']                     = $info['stamp_charge'];

        #mediclaim
        $this->data['insurance_sub_type_id']  = $info['insurance_sub_type_id'];
        $this->data['user_visit_country']     = $info['user_visit_country'];
        $this->data['user_date_of_departure'] = $info['user_date_of_departure'];
        $this->data['user_return_date']       = $info['user_return_date'];

        #falt info
        $this->data['flat_district_id']   = $info['flat_district_id'];
        $this->data['flat_location_id']   = $info['flat_location_id'];
        $this->data['flat_risk_coverage'] = $info['flat_risk_coverage'];
        ##########################################################################################
