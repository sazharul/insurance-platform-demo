...
class CreateDetailsOfShareholdingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('details_of_shareholdings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('details_of_shareholdings');
    }
}
