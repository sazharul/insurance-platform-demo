...
class CreateValueAddedStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('value_added_statements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('value_added_statements');
    }
}
